...
> **平台商測試資料**（官方規格 8981.md）：
>
> | 項目 | 值 |
> |------|-----|
> | PlatformID | `3003008` |
> | 後台帳號 / 密碼 | `StageTestV3P` / `test1234` |
> | 統一編號 | `10608171` |
...
$response = $postService->post([
    ...
    'Data'       => [
        ...
        'CardInfo'     => ['Redeem' => 0, 'OrderResultURL' => 'https://你的網站/ecpay/result'],  // Redeem: 整數 0（PHP SDK 寫法）
        'ConsumerInfo' => [
...
| [02c — App / 正式環境](./02c-ecpg-app-production.md) | iOS/Android App 整合、Apple Pay、正式環境切換 |
